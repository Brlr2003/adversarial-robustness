...
DeepFool~\cite{moosavidezfooli2016deepfool} is the weird one. No epsilon budget. Instead it finds the \emph{minimum} perturbation that changes the prediction. It does this by linearizing the classifier at each step and finding the nearest decision boundary.
