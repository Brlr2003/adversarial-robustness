...
\begin{enumerate}
    ...
    \item \textbf{Attack Implementation:} Implement white-box adversarial attacks (FGSM, BIM/PGD, DeepFool) and evaluate their effectiveness against baseline models.
...
\TODO{Finalize architecture details after implementation}

\subsection{CIFAR-10 Model}

For CIFAR-10, a ResNet-18 architecture or a custom CNN is used depending on computational resources.

\begin{placeholderbox}
Architecture details to be finalized based on available computational resources. Options include ResNet-18, VGG-style network, or custom architecture.
\end{placeholderbox}
...
\TODO{Add pseudocode for DeepFool implementation}
...
\begin{placeholderbox}
C\&W implementation details pending resource availability.
\end{placeholderbox}
...
\begin{placeholderbox}
Training hyperparameters to be finalized: learning rate schedule, number of epochs, batch size.
\end{placeholderbox}
...
\TODO{Add additional experimental configurations as needed}
...
\begin{itemize}
    ...
    \item \textbf{Hardware:} \TODO{Specify GPU/hardware used}
\end{itemize}
