...
This chapter is about how I structured my experiments. I implemented three different attack algorithms, ran them on two benchmark datasets, and then tried adversarial training to see if it helps. I will walk through the datasets, models, attacks, defense, and evaluation metrics below.
...
MNIST~\cite{lecun1998mnist} has 70,000 grayscale images of handwritten digits (0 through 9). The split is 60,000 for training and 10,000 for testing, with each image at 28$\times$28 pixels. It is a simple dataset and models can learn it fast, so I used it mainly to debug my code and make sure the attacks were working correctly before moving on to CIFAR-10.
...
For each experiment I tracked these metrics:
