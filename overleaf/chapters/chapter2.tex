...
\begin{enumerate}
    \item Most works focus on a single attack or a single defense. I found it difficult to locate a study that compares FGSM, PGD, and DeepFool on the same model under the same evaluation protocol. Different papers use different configurations, which makes cross-paper comparison unreliable.
