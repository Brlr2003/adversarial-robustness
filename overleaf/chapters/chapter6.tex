...
\begin{itemize}
    ...
    \item \textbf{Faster adversarial training.} 4.5 hours on CIFAR-10 is already painful. Methods like Adversarial Training for Free~\cite{shafahi2019adversarial} claim to cut the cost significantly.
\end{itemize}
